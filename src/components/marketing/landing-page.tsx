  ...
  return (
    <main id="home" className="min-h-screen bg-[#F9FAFB] text-[#1F2937]">
      ...
      <section className="relative overflow-hidden pb-12 pt-16 sm:pt-20">
        ...
        <div className="lf-shell relative grid items-center gap-14 lg:grid-cols-[minmax(0,1.02fr)_minmax(360px,0.98fr)]">
          <div className="animate-fade-up">
            <p className="mb-4 text-[0.78rem] font-black uppercase tracking-[0.12em] text-[#2563EB]">Modern care, built around trust</p>
            <h1 className="max-w-[730px] font-heading text-[clamp(3rem,7vw,5.8rem)] font-extrabold leading-[1.02] tracking-[-0.055em] text-[#1F2937]">
              Quality healthcare, faster and easier with LifeFirst.
            </h1>
            <p className="mt-6 max-w-[650px] text-[clamp(1.03rem,2.4vw,1.22rem)] leading-[1.82] text-[#475467]">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/register"
                className="inline-flex min-h-[52px] items-center justify-center rounded-[14px] bg-[linear-gradient(135deg,#2563EB,#60A5FA)] px-6 text-sm font-extrabold text-white shadow-[0_16px_32px_rgba(37,99,235,0.26)] transition hover:-translate-y-0.5 hover:shadow-[0_20px_42px_rgba(37,99,235,0.34)]"
              >
                Get Started
              </Link>
              <Link
                href="/login"
                className="inline-flex min-h-[52px] items-center justify-center rounded-[14px] border border-[rgba(37,99,235,0.18)] bg-white px-6 text-sm font-extrabold text-[#2563EB] transition hover:-translate-y-0.5"
              >
                Sign In
              </Link>
            </div>
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {heroStats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-[18px] border border-[rgba(229,231,235,0.82)] bg-white/75 p-[18px] shadow-[0_16px_40px_rgba(31,41,55,0.06)] backdrop-blur-xl"
                >
          ...
          <div className="animate-fade-up-delayed">
            <div className="relative min-h-[430px] overflow-hidden rounded-[28px] border-[7px] border-white bg-white shadow-[0_24px_60px_rgba(37,99,235,0.16)] sm:min-h-[540px] sm:rounded-[36px] sm:border-[10px] lg:min-h-[640px]">
              <Image
                ...
                height={640}
                unoptimized
                className="h-full min-h-[430px] w-full object-cover sm:min-h-[540px] lg:min-h-[640px]"
              />
              <div className="absolute right-4 top-4 flex max-w-full items-center gap-3 rounded-[18px] border border-[rgba(229,231,235,0.86)] bg-white/92 p-4 shadow-[0_10px_30px_rgba(31,41,55,0.08)] backdrop-blur-xl sm:right-6 sm:top-7 sm:max-w-[310px]">
      ...
      <section className="relative z-[3] -mt-4 pb-6 sm:-mt-8">
        <div className="lf-shell grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {trustItems.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="flex gap-4 rounded-[14px] border border-[rgba(229,231,235,0.84)] bg-white/95 p-6 shadow-[0_10px_30px_rgba(31,41,55,0.08)]"
              >
      ...
      <section className="lf-section bg-[linear-gradient(180deg,rgba(239,246,255,0.85),rgba(249,250,251,0.92))]" id="how-it-works">
        <div className="lf-shell grid items-start gap-14 lg:grid-cols-[0.82fr_1.18fr]">
          <div>
          ...
          <div className="grid gap-4">
            {howItWorksSteps.map((step) => (
              <div
                key={step.id}
                className="grid gap-4 rounded-[22px] border border-[rgba(229,231,235,0.9)] bg-white/90 p-6 shadow-[0_10px_30px_rgba(31,41,55,0.08)] transition duration-200 hover:-translate-y-1.5 hover:border-[rgba(37,99,235,0.22)] hover:shadow-[0_28px_70px_rgba(31,41,55,0.12)] sm:grid-cols-[auto_1fr]"
              >
      ...
      <section className="px-0 pb-20 pt-8 sm:pt-10" id="get-started">
        <div className="lf-shell">
          <div className="grid gap-8 overflow-hidden rounded-[32px] bg-[radial-gradient(circle_at_82%_12%,rgba(96,165,250,0.58),transparent_34%),linear-gradient(135deg,#1d4ed8_0%,#2563eb_52%,#10b981_120%)] px-6 py-10 text-white shadow-[0_24px_60px_rgba(37,99,235,0.16)] sm:px-10 sm:py-12 lg:grid-cols-[1fr_auto] lg:items-center lg:px-14 lg:py-16">
            <div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              <Link
                href="/register"
                className="inline-flex min-h-[52px] items-center justify-center rounded-[14px] bg-white px-6 text-sm font-extrabold text-[#2563EB] transition hover:-translate-y-0.5"
              >
                Get Started
              </Link>
              <Link
                href="/login"
                className="inline-flex min-h-[52px] items-center justify-center rounded-[14px] border border-white/35 bg-white/10 px-6 text-sm font-extrabold text-white transition hover:-translate-y-0.5"
              >
                Sign In
              </Link>
            </div>
      ...
      <footer className="border-t border-[#E5E7EB] bg-white py-14" id="contact">
