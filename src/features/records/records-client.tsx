      ...
      <div className="grid gap-4">
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="ct-card-title text-[#1F2937]">Upload Supporting File</p>
              <p className="mt-1 text-sm leading-6 text-slate-600">Add file from device.</p>
            </div>
          </div>
